...
function Main2() {
  ...
  const updateData = () => {
    const newPostKey = push(child(ref(db), "message2")).key;
    console.log(newPostKey);
    const updates = {};

    updates["message2"] = "Xin chào";
  ...
  useEffect(() => {
    ...
    const starCountRef = ref(db, "message2");
  ...
  return loading ? (
    <div className="h-100 d-flex ">
      <div className="header_admin">{"<"}</div>
      <img
        src="/loading.gif"
        width={100}
        height={100}
    ...
    <>
      ...
      <div className="p-5 h-100 d-flex flex-column bg-4btn-page2">
        {!start && (
          <div
            style={{
              flex: 1,
